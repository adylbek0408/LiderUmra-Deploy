...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "blog.Lesson": "fas fa-video",
        "blog.Gallery": "fas fa-camera-retro",
        "blog.Photo": "fas fa-images",
        "blog.FAQ": "fas fa-question-circle",
        "tour": "fas fa-route",
        "tour.Ajy": "fas fa-user",
        "tour.PackageDetail": "fas fa-box",
        "tour.PackageCategory": "fas fa-layer-group",
        "tour.CategoryPackage": "fas fa-tags",
        "tour.Hotel": "fas fa-hotel",
        "tour.Package": "fas fa-box-open",
        "tour.TourDate": "fas fa-calendar-alt",
    },
